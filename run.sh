...
python3 ./experiments/prepare_scenarios.py [decision_tree/pub_trans_comfort_dist-up,decision_tree/pub_trans_punctuality_dist-up,decision_tree/household_cars_dist-down] [0.,0.15,0.3] $SERVICES_NUMBER ./experiments/scenarios
